...
final class EditTrackerViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            completedDays.topAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.topAnchor, constant: 24),
            completedDays.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            completedDays.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            completedDays.heightAnchor.constraint(equalToConstant: 40),
            
            textField.heightAnchor.constraint(equalToConstant: 75),
            textField.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            textField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            textField.topAnchor.constraint(equalTo: completedDays.bottomAnchor, constant: 24),
    ...
    private func setupNavBar() {
        navigationItem.title = NSLocalizedString("editTrackerMain.title", comment: "")
    }
...
extension EditTrackerViewController: WeekTableViewControllerDelegate {
